...
namespace SyntaxHighlighter
{
	public class SyntaxRichTextBox : System.Windows.Forms.RichTextBox
	{
		...
		private void ProcessLine()
		{
            ...
            //Process the words starting with
            if (Settings.EnableVarPrefix)
                ProcessRegex(Settings.VarPrefix+"([a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*)", Settings.VarPrefixColor);
	...
	public class SyntaxSettings
	{
        ...
        string m_strComment = "";
        string m_strVarPrefix = "";
        Color m_colorVarPrefix = Color.Blue;
        ...
        {
            get { return m_strVarPrefix; }
            set { m_strVarPrefix = value; }
        }
        /// <summary>
        /// A string containing the comment identifier.
        /// </summary>
        ...
        /// The color of comments.
        /// </summary>
        public Color VarPrefixColor
        {
            get { return m_colorVarPrefix; }
            set { m_colorVarPrefix = value; }
        }
        /// <summary>
        ...
        /// </summary>
        public bool EnableVarPrefix
        {
            get { return m_bEnableVarPrefix; }
            set { m_bEnableVarPrefix = value; }
        }
        /// <summary>
        /// Enables processing of integers if set to true.
        /// </summary>
